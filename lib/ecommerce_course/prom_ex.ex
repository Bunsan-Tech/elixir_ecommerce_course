defmodule EcommerceCourse.PromEx do
  @moduledoc """
  ...
  use PromEx, otp_app: :ecommerce_course
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: EcommerceCourseWeb.Router, endpoint: EcommerceCourseWeb.Endpoint},
      Plugins.Ecto
      # Plugins.Oban,
      ...
      # EcommerceCourse.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:ecommerce_course, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
